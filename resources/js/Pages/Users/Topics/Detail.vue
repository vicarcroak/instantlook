            ...
            <div class="container">
                <div class="tt-single-topic-list">
                    <div class="tt-item">
                        <div class="tt-single-topic">
                            ...
                            <div class="tt-item-description">
                                ...
                                <p>
                                    It’s time to channel your inner Magnum P.I., Ron Swanson or Hercule Poroit! It’s the time
                                    that all guys (or gals) love and all our
                                    partners hate It’s Movember!
                                </p>
                                <p>
                                    Throughout November we will be inviting all community members to help raise awareness and
                                    funds for the lives of men affected
                                    by cancer and mental health problems via the Movember Foundation 10.
                                </p>
                                <h6 class="tt-title">How Does it Work?</h6>
                                <p>
                                    Authors and customers with facial hair unite! Simply grow, groom, and share your facial hair
                                    during November! Even females can enter if they desire (be creative, ladies!). Be inspired
                                    by checking out last year’s highlights 28.
                                </p>
                            </div>
                            <div class="tt-item-info info-bottom">
                                <a class="tt-icon-btn" href="#">
                                    <i class="tt-icon">
                                        <svg>
                                ...
                                <a class="tt-icon-btn tt-hover-02 tt-small-indent" href="#">
                                    <i class="tt-icon">
                                        <svg>
                    ...
                    <div class="tt-item">
                        <div class="tt-info-box">
                            ...
                            <div class="tt-row-icon">
                                <div class="tt-item">
                                    <a class="tt-icon-btn tt-position-bottom" href="#">
                                        <i class="tt-icon">
                                            <svg>
                                                <use xlink:href="#icon-reply"></use>
                                            </svg>
                        ...
                        <div class="tt-single-topic">
                            ...
                            <div class="tt-item-description">
                                <p>
                                    ...
                                    items to 60 pages it is 1800 items in
                                    categories eg in Add-Ons category have 22749 items, why not see all of them but only those
                                    1800 items? This is a bad thing.
                                </p>
                                <p>
                                    <img alt="" class="tt-offset-11" src="images/single-topic-img01.jpg">
                                </p>
                            </div>
                            <div class="tt-item-info info-bottom">
                                <a class="tt-icon-btn" href="#">
                    ...
                    <div class="tt-item">
                        <div class="tt-single-topic">
                            ...
                            <div class="tt-item-description">
                                <p>
                                    I do not like. Choosing a template has become more difficult.<br>Small thumbnails 80x80px
                                    were better.
                                </p>
                                <div class="video-container">
                                    <iframe allowfullscreen src="https://www.youtube.com/embed/BbW8djS7kI4"
                        ...
                        <div class="tt-single-topic">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto ml-auto">
                                    <a class="btn btn-primary tt-offset-27" href="#">Show Reply</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row tt-offset-37">
                                    <div class="col-lg-10">
                                        <div class="tt-gallery-layout">
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img03.jpg"><img
                                                    alt="" src="images/single-topic-img03.jpg"></a>
                                            </div>
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img04.jpg"><img
                                                    alt="" src="images/single-topic-img04.jpg"></a>
                                            </div>
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img05.jpg"><img
                                                    alt="" src="images/single-topic-img05.jpg"></a>
                                            </div>
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img06.jpg"><img
                                                    alt="" src="images/single-topic-img06.jpg"></a>
                                            </div>
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img07.jpg"><img
                                                    alt="" src="images/single-topic-img07.jpg"></a>
                                            </div>
                                            <div class="tt-item">
                                                <a class="tt-gallery-obj" href="images/single-topic-img08.jpg"><img
                                                    alt="" src="images/single-topic-img08.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tt-wrapper-inner">
                    <div class="pt-editor form-default">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="message" placeholder="Lets get started" rows="5"></textarea>
                        </div>
                        <div class="pt-row">
                            <div class="col-auto">
                                <div class="checkbox-group">
                                    <input checked="" id="checkBox21" name="checkbox" type="checkbox">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-secondary btn-width-lg" href="#">Reply</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tt-topic-list tt-ofset-30">
                        ...
                        <div class="tt-search">
                            <form class="search-wrapper">
                                <div class="search-form">
                                    <input class="tt-search__input" placeholder="Search for topics" type="text">
                    ...
                    <div class="tt-row-btn">
                        <button class="btn-icon js-topiclist-showmore" type="button">
                            <svg class="tt-icon">
