                    ...
                    <form class="form-default form-create-topic">
                        <div class="form-group">
                            ...
                            <div class="tt-value-wrapper">
                                <input class="form-control" id="inputTopicTitle" name="name" placeholder="Subject of your topic"
                                       type="text">
                        ...
                        <div class="pt-editor">
                            ...
                            <div class="form-group">
                        <textarea class="form-control" name="message" placeholder="Lets get started"
                                  rows="5"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="inputTopicTags" name="name" placeholder="Use comma to separate tags"
                                               type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-auto ml-md-auto">
                                    <a class="btn btn-secondary btn-width-lg" href="#">Create Post</a>
                                </div>
                            </div>
                        </div>
                    </form>
