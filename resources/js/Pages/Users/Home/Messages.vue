                        ...
                        <div class="col-md-4 tt-aside" id="js-aside">
                            ...
                            <div class="tt-all-avatar">
                                <div class="tt-box-search">
                                    <input class="tt-input" placeholder="Search messages" type="text">
                                    <a class="tt-btn-input" href="#">
                                        <svg>
                            ...
                            <div class="tt-list-time-topic">
                                ...
                                <div class="tt-item">
                                    ...
                                    <div class="tt-col-description">
                                        ...
                                        <p>How is it going man? Did you see my new forum <a class="tt-underline-02" href="#">post?</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="tt-item">
                                    ...
                                    <div class="tt-col-description">
                                        ...
                                        <p>Hey, going good, what about you? yes I saw your post, great stuff man <a class="tt-underline-02"
                                                                                                                    href="#">post?</a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <textarea class="form-control" name="message" placeholder="Write your message here"
                                    ...
                                    <div class="pt-row">
                                        <div class="col-auto ml-auto">
                                            <a class="btn btn-secondary btn-custom" href="#">Send</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
