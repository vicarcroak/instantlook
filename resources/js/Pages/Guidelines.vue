                    ...
                    <div class="tab-content">
                        <div class="tab-pane show fade active" id="tt-tab-01" role="tabpanel">
                            <div class="tt-layout-tab">
                                <div class="tt-wrapper-inner">
                                    ...
                                    Forum 19 is a community of creatives who come together to share ideas and help each other
                                    succeed.
                                    <h3 class="tt-title">
                                        Admins
                                    </h3>
                        ...
                        <div class="tab-pane" id="tt-tab-02" role="tabpanel">
                            <div class="tt-wrapper-inner tt-layout-tab">
                                ...
                                <p>Envato is a community of creatives who come together to share ideas and help each other
                                    succeed.</p>
                                <p>
                                    We invite you to join in, but do have a few rules. The rules and values below exist to help
                                    you understand what it means to be a member of the community and cover all aspects of
                                    community interaction on Envato forums, blogs, contests and events. We’re committed to
                                    upholding them, and we hope you will be too.
                                </p>
                                <dl class="dl-layout-01">
                                    <dt>We believe when the community succeeds, we succeed.</dt>
                                    <dd>
                                        We love healthy competition, but feel we’re all better off when we’re sharing ideas,
                                        knowledge and skills and helping one another. We come to give back, not shamelessly
                                        self-promote.
                                    </dd>
                                    <dt>
                                    ...
                                    <dd>
                                        We are from all corners of the earth and a glorious melting pot of creative fields,
                                        skill levels, cultures, religions and more. We think the opportunity for anyone to
                                        achieve success no matter where they come from leads to a more meritocratic and equal
                                        world.
                                    </dd>
                                    <dt>
                                    ...
                                    <dd>
                                        ...
                                        constructive and respectful. Personal attacks as well as any behavior that is hateful or
                                    ...
                                    <dd>
                                        By collaborating with people from different backgrounds, we are exposed to new ideas and
                                    ...
                                    <dd>
                                        We’re all students and teachers. Our world moves super fast and we stay ahead of the
                                        pack by pushing and pulling each other forward. We don’t follow the trends, we make
                                        them.
                                    </dd>
                                </dl>
                                <h6 class="tt-title">We follow a few hard rules. Please DON’T:</h6>
                                <ul class="tt-list-dot tt-indent-top01">
                                    <li>Participate in or encourage personal attacks, call out another user and/or sabotage a
                                        user’s item.
                                    </li>
                                    ...
                                    <li>Discuss pricing of items/services in an author-driven pricing category or on Studio.
                                    </li>
                                    <li>Talk about or link to piracy, warez, illegal activity of any kind, or competitor sites
                                        or items.
                                    </li>
                                    <li>Request or post personal (or identifying) information about any user or any other
                                        person.
                                    </li>
